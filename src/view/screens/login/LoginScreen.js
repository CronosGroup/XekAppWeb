                ...
                <View style={styles.container}>
                    ...
                    <ScrollView style={styles.scrollView} contentContainerStyle={styles.container_scrollView}>
                        ...
                        {this.state.lastNameError ?
                            <Text
                                style={styles.errorName}>{languages.getLocalized("login_error_last_name")}</Text> : null}
                        ...
                        <TouchableOpacity activeOpacity={0.7} style={styles.buttonRecovery}
                            ...
                            <Text
                                style={styles.buttonRecoveryText}>{languages.getLocalized("login_recover_account")}</Text>
                        </TouchableOpacity>
                    </ScrollView>
