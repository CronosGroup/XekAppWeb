class En {
    static strings = {
        ...
        email_verify_message:"Verify the link in the email you have provided us, to access the map of infected and symptoms in your área. Verify that it is not in the SPAM folder",
